...
while amount_of_candy != 0:
    if player_turn % 2 == 1:
        ...
        if amount_of_candy < 28:
            take_some_candies = random.randint(1, amount_of_candy)
            print(f'Бот взял конфет: {take_some_candies}')
        else:
            take_some_candies = random.randint(1, 28)
            print(f'Бот взял конфет: {take_some_candies}')
        ...
        take_some_candies = 0
        player_turn = player_turn % 2 + 1
        print('У бота всего конфет:', player_two_number_of_candies)
        print('В куче осталось конфет:', amount_of_candy)
        print()
...
if player_turn % 2 == 0:
    ...
    print(f'Победил бот. Собрал конфет: {player_two_number_of_candies}')
